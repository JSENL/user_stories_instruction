/** discussion **
 * 1st general comment from Kay: Many of these stories are very useful and clearly written. Nice work! Others need revision. I've commented on 2 of the latter. The comments apply to others. Mind doing another iteration?
 ...
 * Regarding actions: (important) Be sure to describe the user's requirements vs the mechanics (i.e. describe the problem, not the solution). I'm also tweaking the benefit statement; use
